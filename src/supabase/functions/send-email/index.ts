...
const FROM_EMAIL = 'Gray Haven Bank <noreply@grayhavenbk.com>';
...
function welcomeTemplate(data: Record<string, unknown>) {
  ...
  return {
    subject: 'Welcome to Gray Haven Bank — Your Account is Active',
    html: `
<!DOCTYPE html>
<html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1">
<title>Welcome to Gray Haven Bank</title></head>
      ...
      <table width="600" cellpadding="0" cellspacing="0" style="background:#111827;border-radius:16px;overflow:hidden;border:1px solid #1e293b;">
        <tr><td style="background:linear-gradient(135deg,#027976,#013d36);padding:40px;text-align:center;">
          <div style="display:inline-flex;align-items:center;gap:10px;">
            ...
            <span style="color:#fff;font-size:22px;font-weight:800;letter-spacing:1px;">GRAY HAVEN BANK</span>
          </div>
        ...
        <tr><td style="padding:40px;">
          ...
          <p style="color:#94a3b8;font-size:16px;line-height:1.6;margin:0 0 24px;">
            Your Gray Haven Bank account has been successfully created. You now have access to world-class digital banking services.
          </p>
          ...
          <div style="text-align:center;margin:32px 0;">
            <a href="https://grayhavenbk.com/dashboard" style="background:linear-gradient(135deg,#027976,#015d58);color:#fff;text-decoration:none;padding:16px 40px;border-radius:10px;font-weight:700;font-size:16px;display:inline-block;">Access Your Dashboard →</a>
          </div>
        ...
        <tr><td style="background:#0f172a;padding:24px;text-align:center;border-top:1px solid #1e293b;">
          <p style="color:#475569;font-size:12px;margin:0;">© 2026 Gray Haven Bank. All rights reserved.</p>
          <p style="color:#475569;font-size:12px;margin:8px 0 0;">
            <a href="https://grayhavenbk.com" style="color:#027976;text-decoration:none;">grayhavenbk.com</a> &nbsp;|&nbsp;
            <a href="mailto:support@grayhavenbk.com" style="color:#027976;text-decoration:none;">support@grayhavenbk.com</a>
          </p>
        </td></tr>
      </table>
    </td></tr>
...
function loginAlertTemplate(data: Record<string, unknown>) {
  ...
  return {
    subject: '🔐 New Login Detected — Gray Haven Bank',
    html: `
    ...
    <tr><td align="center">
      <table width="600" cellpadding="0" cellspacing="0" style="background:#111827;border-radius:16px;overflow:hidden;border:1px solid #1e293b;">
        <tr><td style="background:linear-gradient(135deg,#027976,#013d36);padding:30px;text-align:center;">
          <span style="color:#fff;font-size:20px;font-weight:800;">🏦 GRAY HAVEN BANK</span>
        </td></tr>
        <tr><td style="padding:40px;">
          ...
          <p style="color:#94a3b8;font-size:14px;text-align:center;">If this wasn't you, contact us immediately at <a href="mailto:security@grayhavenbk.com" style="color:#027976;">security@grayhavenbk.com</a></p>
        </td></tr>
        <tr><td style="background:#0f172a;padding:20px;text-align:center;border-top:1px solid #1e293b;">
          <p style="color:#475569;font-size:12px;margin:0;">© 2026 Gray Haven Bank · <a href="https://grayhavenbk.com" style="color:#027976;">grayhavenbk.com</a></p>
        </td></tr>
      </table>
    </td></tr>
  </table>
      ...
      <table width="600" cellpadding="0" cellspacing="0" style="background:#111827;border-radius:16px;overflow:hidden;border:1px solid #1e293b;">
        ...
        <tr><td style="padding:40px;">
          ...
          <div style="text-align:center;">
            <a href="https://grayhavenbk.com/dashboard/transactions" style="background:linear-gradient(135deg,#027976,#015d58);color:#fff;text-decoration:none;padding:14px 32px;border-radius:10px;font-weight:700;font-size:14px;display:inline-block;">View Transaction History →</a>
          </div>
        </td></tr>
        <tr><td style="background:#0f172a;padding:20px;text-align:center;border-top:1px solid #1e293b;">
          <p style="color:#475569;font-size:12px;margin:0;">© 2026 Gray Haven Bank · <a href="https://grayhavenbk.com" style="color:#027976;">grayhavenbk.com</a></p>
...
function kycTemplate(data: Record<string, unknown>) {
  ...
  return {
    subject: `KYC Verification ${statusText} — Gray Haven Bank`,
    html: `
<!DOCTYPE html><html><head><meta charset="utf-8"></head>
<body style="margin:0;padding:0;background:#0a0f20;font-family:'Helvetica Neue',Arial,sans-serif;">
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#0a0f20;padding:40px 0;">
      ...
      <table width="600" cellpadding="0" cellspacing="0" style="background:#111827;border-radius:16px;overflow:hidden;border:1px solid #1e293b;">
        ...
        <tr><td style="padding:40px;text-align:center;">
          ...
          <div style="background:#1e293b;border-radius:12px;padding:20px;text-align:left;margin:0 0 24px;">
            ...
            ${notes ? `<div style="padding:12px 0;"><span style="color:#94a3b8;font-size:13px;display:block;margin-bottom:4px;">Notes</span><span style="color:#f1f5f9;font-size:14px;">${notes}</span></div>` : ''}
          </div>
          ...
          <a href="https://grayhavenbk.com/dashboard" style="background:linear-gradient(135deg,#027976,#015d58);color:#fff;text-decoration:none;padding:14px 32px;border-radius:10px;font-weight:700;font-size:14px;display:inline-block;margin-top:16px;">Go to Dashboard →</a>
        </td></tr>
        <tr><td style="background:#0f172a;padding:20px;text-align:center;border-top:1px solid #1e293b;">
          <p style="color:#475569;font-size:12px;margin:0;">© 2026 Gray Haven Bank · <a href="https://grayhavenbk.com" style="color:#027976;">grayhavenbk.com</a></p>
        </td></tr>
...
serve(async (req) => {
  ...
  try {
    ...
    const resendRes = await fetch('https://api.resend.com/emails', {
      ...
      body: JSON.stringify({ from: FROM_EMAIL, to: [to], subject: emailContent.subject, html: emailContent.html }),
    });
