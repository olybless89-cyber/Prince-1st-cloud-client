  ...
  return (
    <div className="space-y-8 max-w-5xl">
      ...
      {accounts.length === 0 ? (
        ...
        <div className="rounded-2xl bg-gradient-to-br from-[#02796b] to-[#013d36] p-8 text-white teal-glow">
                ...
                return (
                  <div key={txn.id} className="flex items-center gap-4 p-4 hover:bg-secondary/30 transition-colors">
                    <div className={cn('w-10 h-10 rounded-full flex items-center justify-center shrink-0', isCredit ? 'bg-green-500/10' : 'bg-red-500/10')}>
                      <Icon className={cn('w-4 h-4', isCredit ? 'text-green-400' : 'text-red-400')} />
                    </div>
                    ...
                    <div className={cn('font-semibold text-sm shrink-0', isCredit ? 'text-green-400' : 'text-red-400')}>
