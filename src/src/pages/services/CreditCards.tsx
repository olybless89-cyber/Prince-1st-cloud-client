...
const CARDS = [
  { name: 'Gray Haven Classic', tier: 'Standard', color: 'from-gray-600 to-gray-900', features: ['1% cashback all purchases', 'Zero annual fee', 'Contactless payments', '24/7 fraud monitoring'] },
  { name: 'Gray Haven Prestige', tier: 'Premium', color: 'from-primary to-[#013d36]', features: ['4% dining cashback', '3% travel cashback', '2% grocery cashback', 'Airport lounge access', 'Concierge service'], featured: true },
  { name: 'Gray Haven Infinite', tier: 'Luxury', color: 'from-[#1a1a2e] to-[#000]', features: ['Unlimited cash back', 'No foreign transaction fees', 'Global Priority Pass', 'Personal financial advisor', 'Metal card'] },
];
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-10 items-start">
            ...
            <div className="glass-card rounded-2xl p-8 border border-border">
              ...
              {/* Preview card */}
              <div className="mt-6">
                <div className="bg-gradient-to-br from-primary to-[#013d36] rounded-2xl p-6 teal-glow">
                  <div className="flex justify-between mb-6">
                    <span className="text-white/60 text-xs">Gray Haven Prestige</span>
            ...
            <div className="glass-card rounded-2xl p-8 border border-border">
              ...
              <div className="mt-8 p-6 rounded-2xl bg-gradient-to-br from-primary to-[#013d36] text-center teal-glow">
