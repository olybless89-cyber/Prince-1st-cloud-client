...
const PLANS = [
  { name: 'Micro Tier', tag: 'Entry Level', roi: '150%', type: 'Total Return', min: '$500', max: '$2,999', duration: '5 Days', color: 'from-[#1a3a5c] to-[#0a0f20]', features: ['$500 min investment', '5-day cycle', 'Auto-reinvest option', 'Email notifications'] },
  { name: 'Growth Plus', tag: 'Most Popular', roi: '16%', type: 'Daily ROI', min: '$100', max: '$25,000', duration: '60 Days', color: 'from-primary to-[#013d36]', featured: true, features: ['$100 min investment', 'Daily profit release', 'Portfolio dashboard', 'Priority support'] },
  { name: 'Standard Alpha', tag: 'Institutional', roi: '2.5%', type: 'Daily ROI', min: '$25,000', max: '$100,000', duration: '60 Days', color: 'from-[#2d1a5c] to-[#0a0f20]', features: ['$25,000 min investment', 'Dedicated RM', 'Real-time tracking', 'Weekly reports'] },
  { name: 'Gold Premium', tag: 'Elite Wealth', roi: '5%', type: 'Daily ROI', min: '$100,000', max: '$500,000', duration: '90 Days', color: 'from-[#3d3a02] to-[#0a0f20]', features: ['$100,000 min investment', 'Private wealth team', 'Custom allocation', 'Quarterly review'] },
];
  ...
  return (
    <div className="min-h-screen pt-20">
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-extrabold text-foreground mb-4">Why Invest With Gray Haven?</h2>
          </div>
