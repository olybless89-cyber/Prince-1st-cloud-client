...
**Endpoint**: `POST https://app-dkpgdv8fqio1-api-79jKPlpvAJ0L.gateway.appmedo.com/assistant/session`
...
**Endpoint**: `POST https://app-dkpgdv8fqio1-api-oYA6ZxVqyK8a.gateway.appmedo.com/assistant/session/{session_id}`
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstream = await fetch(
    "https://app-dkpgdv8fqio1-api-79jKPlpvAJ0L.gateway.appmedo.com/assistant/session",
    {
      method: "POST",
      headers: {
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstream = await fetch(
    `https://app-dkpgdv8fqio1-api-oYA6ZxVqyK8a.gateway.appmedo.com/assistant/session/${sessionId}`,
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
