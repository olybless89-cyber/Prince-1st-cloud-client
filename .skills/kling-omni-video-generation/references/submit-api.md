...
| Property | Value |
|----------|-------|
| Endpoint | `POST https://app-dkpgdv8fqio1-api-k93RvqRrRZba.gateway.appmedo.com/v1/videos/omni-video` |
| HTTP Method | `POST` |
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstream = await fetch(
    "https://app-dkpgdv8fqio1-api-k93RvqRrRZba.gateway.appmedo.com/v1/videos/omni-video",
    {
      method: "POST",
      headers: {
