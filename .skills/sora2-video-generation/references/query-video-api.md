...
| Item | Details |
|------|---------|
| Endpoint | `POST https://api-DYJwnoM46d6a@app-dkpgdv8fqio1-api-DYJwnoM46d6a.gateway.appmedo.com` |
...
async function queryVideoStatus(videoId: string): Promise<VideoStatusResponse> {
  const response = await fetch(
    "https://api-DYJwnoM46d6a@app-dkpgdv8fqio1-api-DYJwnoM46d6a.gateway.appmedo.com",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
