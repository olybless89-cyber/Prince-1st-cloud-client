...
| Item | Details |
|------|---------|
| Endpoint | `POST https://app-dkpgdv8fqio1-api-GaDwZ8DX7jPY.gateway.appmedo.com/language/translate/v2` |
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstream = await fetch(
    "https://app-dkpgdv8fqio1-api-GaDwZ8DX7jPY.gateway.appmedo.com/language/translate/v2",
    {
      method: "POST",
      headers: {
